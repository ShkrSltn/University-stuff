...
namespace Lab_3
{
    public partial class Form1 : Form
    {
        ...
        private void Load_Form(object sender,EventArgs e)
        {
            ...
            graphics.DrawLine(new Pen(colorPen, 1), 0, 0, picture.Width, 0);
            graphics.DrawLine(new Pen(colorPen, 1), picture.Width-1, 0, picture.Width-1, picture.Height);
            graphics.DrawLine(new Pen(colorPen, 1), 0, picture.Height-1, picture.Width - 1, picture.Height-1);
            graphics.DrawLine(new Pen(colorPen, 1), 0, 0, 0, picture.Height);
